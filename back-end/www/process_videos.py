...
rgb_dir = "/home/paperspace/git/deep-smoke-machine/back-end/data/extracted-data/npy/rgb"
flow_dir = "/home/paperspace/git/deep-smoke-machine/back-end/data/extracted-data/npy/flow"
video_dir = "/home/paperspace/git/deep-smoke-machine/back-end/data/videos"

# Process videos into rgb frame files and optical flow files
# The file format is numpy.array
def main(argv):    
    metadata_path = "/home/paperspace/git/deep-smoke-machine/back-end/data/metadata.json"
    num_workers = 1
